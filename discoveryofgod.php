...
// Hämta artiklar från kategori Discovering God
$stmt = $db->prepare("SELECT * FROM articles WHERE category='Discovering God' ORDER BY date DESC LIMIT :limit OFFSET :offset");
$stmt->bindValue(':limit', $limit, SQLITE3_INTEGER);
$stmt->bindValue(':offset', $offset, SQLITE3_INTEGER);
$results = $stmt->execute();

// Räkna antal artiklar i Discovering God
$total = $db->querySingle("SELECT COUNT(*) FROM articles WHERE category='Discovering God'");
...
<title>د خدای دریافت – ارشیف</title>
<link rel="stylesheet" href="styles.css">
</head>
<body>
<?php include 'nav.php'; ?>
<main class="container">
  <h2>د خدای دریافت په اړه مقالې</h2>
  <div class="grid">
