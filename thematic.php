...
// Hämta tematiska artiklar
$stmt = $db->prepare("SELECT * FROM articles WHERE category='Tematisk läsning' ORDER BY date DESC LIMIT :limit OFFSET :offset");
$stmt->bindValue(':limit', $limit, SQLITE3_INTEGER);
$stmt->bindValue(':offset', $offset, SQLITE3_INTEGER);
$results = $stmt->execute();

// Räkna antal artiklar
$total = $db->querySingle("SELECT COUNT(*) FROM articles WHERE category='Tematisk läsning'");
$pages = ceil($total / $limit);
?>
<!doctype html><html lang="ps" dir="rtl"><head>
<meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1">
<title>تماتیک لیکنې</title>
<link rel="stylesheet" href="styles.css">
</head><body>
<?php include 'nav.php'; ?>
<main class="container">
  <h2>تماتیک لیکنې -  ارشیف</h2>
  <div class="grid">
