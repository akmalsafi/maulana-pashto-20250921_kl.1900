...
// Hämta artiklar från kategori Paradise
$stmt = $db->prepare("SELECT * FROM articles WHERE category='Paradise' ORDER BY date DESC LIMIT :limit OFFSET :offset");
$stmt->bindValue(':limit', $limit, SQLITE3_INTEGER);
$stmt->bindValue(':offset', $offset, SQLITE3_INTEGER);
$results = $stmt->execute();

// Räkna antal artiklar i Paradise
$total = $db->querySingle("SELECT COUNT(*) FROM articles WHERE category='Paradise'");
...
<title>جنت – ارشیف</title>
<link rel="stylesheet" href="styles.css">
</head>
<body>
<?php include 'nav.php'; ?>
<main class="container">
  <h2>د جنت په اړه مقالې – ارشیف</h2>
  <div class="grid">
